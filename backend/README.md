...
## Project Structure
    ...
    ├── testapiautoconnect_101534  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_101534`
...
2. Clone this repo and `cd testapiautoconnect_101534`
